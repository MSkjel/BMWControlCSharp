...
namespace BMWControl.Handlers.ButtonHandler
{
    public class MultiMediaButtonHandler
    {
        ...
        public IButtonEvent SteeringWheelDiamond = new IButtonEvent("Steering_Wheel_Diamond", CanID.STEERING_WHEEL_CONTROLS, new byte[] { CanValue.STEERING_WHEEL_BUTTON_PHONE_DIAMOND_STAR_HORN, CanValue.STEERING_WHEEL_BUTTON_DIAMOND });
        public IButtonEvent SteeringWheelStar = new IButtonEvent("Steering_Wheel_Star", CanID.STEERING_WHEEL_CONTROLS, new byte[] { CanValue.STEERING_WHEEL_BUTTON_PHONE_DIAMOND_STAR_HORN, CanValue.STEERING_WHEEL_BUTTON_STAR });
